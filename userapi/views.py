...
class UserViewSet(viewsets.ViewSet):
  ...
  def delete(self, request, pk=None):
    try:
      ...
      return custom_response("Se elimino el usuario correctamente", None, False, status.HTTP_400_BAD_REQUEST)
    
    query.delete()
    return custom_response("Usuario eliminado correctamente", None, False, status.HTTP_200_OK)
